            ...
            for line in f:
                ...
                if appending:
                    ...
                    if len(splits) == 4:
                        ...
                        fw.write(splits[1]+"\t"+splits[2]+"\t"+splits[3]+"\n")
                        fe.append(splits[2])
...
store_path = "data/test_format.txt"
parser = Parser(datapath, store_path)
parser.parse()


datapath = "data/train.txt"
store_path = "data/train_format.txt"
parser = Parser(datapath, store_path)
parser.parse()


datapath = "data/dev.txt"
store_path = "data/dev_format.txt"
parser = Parser(datapath, store_path)
parser.parse()